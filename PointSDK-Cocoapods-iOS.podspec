Pod::Spec.new do |s|
  ...
  s.homepage = "https://www.bluedotinnovation.com"
  s.license = {
    :type => 'Copyright',
    :text => <<-LICENSE
    ...
    https://www.bluedotinnovation.com/html/downloads/pdfs/terms-and-conditions-bluedot-070814.pdf and Privacy Policy https://www.bluedotinnovation.com/html/downloads/pdfs/privacy-policy-bluedot-170815.pdf
    and Billing Policy https://www.bluedotinnovation.com/html/downloads/pdfs/privacy-policy-bluedot-170815.pdf
    and acknowledge that such terms govern Your use of and access to the iOS SDK.

    LICENSE
  }
  s.author = { "Bluedot Innovation" => "https://www.bluedotinnovation.com" }
